                ...
                <div class="col-lg-5 col-xl-3 chat-cont-left d-flex">
                    <div class="card mb-sm-3 mb-md-0 contacts_card flex-fill">
                        ...
                        <div class="card-body contacts_body chat-users-list chat-scroll">
                            ...
                            <a href="javascript:void(0);" wire:click='selectChat({{ $user->id }})'
                                class="media d-flex active">
                                <div class="media-img-wrap flex-shrink-0">
                                    <div class="avatar avatar-online">
                                        <img src="{{ asset('assets/imgs') }}/{{ $user->profile_photo_path }}"
                                            alt="User Image" class="avatar-img rounded-circle">
                                    </div>
                                </div>
                                <div class="media-body flex-grow-1">
                                    <div>
                                        <div class="user-name text-yellow-500 font-bold">{{ $user->name }}</div>
                    ...
                    <div class="card mb-0">
                        ...
                        <div class="card-body msg_card_body chat-scroll pt-0">
                            <ul class="list-unstyled">
                                ...
                                <li
                                    class="media {{ $message->user_id != Auth::user()->id ? 'received' : 'sent' }} d-flex">
                                    ...
                                    <div class="media-body flex-grow-1">
                                        <div class="msg-box">
                                            <div>
                                                <ul class="chat-msg-info mb-1">
                                                    <li><span>{{ $message->user->name }}</span></li>
                                                    <li>
                                                        <span class="chat-time flex w-40">{{$message->created_at->format('h:i A') }}</span>
                                                    </li>
                           ...
                           <form wire:submit.prevent="sendMessage">
                                    <div class="input-group">
                                        ...
                                        <div class="send-action">
                                            ...
                                            <button type="submit" class="btn btn-primary btn_send"><i class="fas fa-paper-plane text-white"
