                ...
                <div class="col-12 ">
                    <form wire:submit.prevent='editBlog' enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="image" class="label-control">Blog image</label>
                                    <input type="file" name="image" id="image" class="form-control rounded-lg"
                                        wire:model='image'>
                                    @error('image')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-12">
                                <div class="form-group" wire:ignore>
                                    ...
                                    <textarea name="description" id="description" 
                                        class="form-control" wire:nodel='description'></textarea>
                            ...
                            <div class="col-md-12">
                                <div class="flex justify-end">
                                    <button type="submit" class="btn btn-sm bg-black text-white">Add Blog</button>
                                </div>
                            </div>
                        </div>
