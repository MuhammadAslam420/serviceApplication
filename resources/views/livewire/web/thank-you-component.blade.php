<div>
    <div class="bg-img">
        ...
        <img src="assets/imgs/feature-bg-03.png" alt="img" class="bgimg3 w-50">
    </div>
                    ...
                    <ul class="step-register row">
                        <li class="activate col-md-4">
                            <div class="multi-step-icon">
                                <span><img src="assets/imgs/calendar-icon.svg" alt="img"></span>
                            </div>
                        ...
                        <li class="activate col-md-4">
                            <div class="multi-step-icon">
                                <span><img src="assets/imgs/wallet-icon.svg" alt="img"></span>
                            </div>
                            <div class="multi-step-info">
                        ...
                        <li class="active col-md-4">
                            <div class="multi-step-icon">
                                <span><img src="assets/imgs/book-done.svg" alt="img"></span>
                            </div>
                            <div class="multi-step-info">
                                <h6>Done </h6>
                    ...
                    <div class="row">
                        <div class="col-md-10 mx-auto">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6">
                                    <div class="booking-done">
                                        <img src="assets/imgs/booking-done.png" class="img-fluid" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>						
