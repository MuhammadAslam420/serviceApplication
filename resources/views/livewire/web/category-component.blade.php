        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-12">
                    <h2 class="breadcrumb-title">Services Available Against This Category</h2>
                    <nav aria-label="breadcrumb" class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">All Available Services of Category</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                    ...
                                    <div class="service-img">
                                        <a href="{{ route('service_detail',['slug'=>$service->slug]) }}" wire:click='countViews("{{ $service->id }}")'>
                                            <img class="img-fluid serv-img" alt="Service Image"
                                                src="{{ asset('assets/imgs/services/default') }}/{{ $service->image }}">
                                        </a>
                                        <div class="fav-item">
                                            <a
                                ...
                                <div class="service-list">
                                    <div class="service-cont">
                                        <div class="service-cont-img">
                                            <a href="#">
                                                <img class="img-fluid serv-img" alt="Service Image"
                                                    src="{{ asset('assets/imgs/non-record.jpeg') }}">
                                            </a>
