<div class="fixed z-10 inset-0 overflow-y-auto ease-out">
                    ...
                    <div class="">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text"
                                ...
                                id="exampleFormControlInput1" placeholder="Update role" wire:model="editRoleName"
                                name="editRoleName">

                            @error('editRoleName') <span class="text-red-500">{{ $message }}</span>@enderror
